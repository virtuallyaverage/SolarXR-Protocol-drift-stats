...
public final class TrackerData extends Table {
   ...
   */
  public solarxr_protocol.datatypes.driftCompData driftCompData() { return driftCompData(new solarxr_protocol.datatypes.driftCompData()); }
  public solarxr_protocol.datatypes.driftCompData driftCompData(solarxr_protocol.datatypes.driftCompData obj) { int o = __offset(28); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  ...
  public static void addDriftCompData(FlatBufferBuilder builder, int driftCompDataOffset) { builder.addOffset(12, driftCompDataOffset, 0); }
  ...
  public void unpackTo(TrackerDataT _o) {
    ...
    _o.setTps(_oTps);
    if (driftCompData() != null) _o.setDriftCompData(driftCompData().unpack());
    else _o.setDriftCompData(null);
  }
  public static int pack(FlatBufferBuilder builder, TrackerDataT _o) {
    ...
    int _driftCompData = _o.getDriftCompData() == null ? 0 : solarxr_protocol.datatypes.driftCompData.pack(builder, _o.getDriftCompData());
    ...
    addDriftCompData(builder, _driftCompData);
