...
public final class TrackerDataMask extends Table {
  ...
  public boolean driftCompData() { int o = __offset(26); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  ...
  public static void addDriftCompData(FlatBufferBuilder builder, boolean driftCompData) { builder.addBoolean(11, driftCompData, false); }
  ...
  public void unpackTo(TrackerDataMaskT _o) {
    ...
    boolean _oTps = tps();
    _o.setTps(_oTps);
    boolean _oDriftCompData = driftCompData();
    _o.setDriftCompData(_oDriftCompData);
  }
