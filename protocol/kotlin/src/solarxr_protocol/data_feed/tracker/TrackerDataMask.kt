...
class TrackerDataMask : Table() {
    ...
    companion object {
        ...
        @JvmStatic
        fun createTrackerDataMask(builder: FlatBufferBuilder, info: Boolean, status: Boolean, rotation: Boolean, position: Boolean, rawAngularVelocity: Boolean, rawAcceleration: Boolean, temp: Boolean, linearAcceleration: Boolean, rotationReferenceAdjusted: Boolean, rotationIdentityAdjusted: Boolean, tps: Boolean, driftCompData: Boolean) : Int {
            builder.startTable(12)
            addDriftCompData(builder, driftCompData)
            addTps(builder, tps)
        ...
        @JvmStatic
        fun addDriftCompData(builder: FlatBufferBuilder, driftCompData: Boolean) = builder.addBoolean(11, driftCompData, false)
        @JvmStatic
