...
impl<'a> TrackerDataMask<'a> {
  ...
  pub const VT_DRIFT_COMP_DATA: flatbuffers::VOffsetT = 26;
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    builder.add_drift_comp_data(args.drift_comp_data);
  ...
  #[inline]
  pub fn drift_comp_data(&self) -> bool {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(TrackerDataMask::VT_DRIFT_COMP_DATA, Some(false)).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for TrackerDataMask<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<bool>("drift_comp_data", Self::VT_DRIFT_COMP_DATA, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> TrackerDataMaskBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_drift_comp_data(&mut self, drift_comp_data: bool) {
    self.fbb_.push_slot::<bool>(TrackerDataMask::VT_DRIFT_COMP_DATA, drift_comp_data, false);
  }
  #[inline]
