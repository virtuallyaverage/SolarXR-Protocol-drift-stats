...
static addDriftCompData(builder:flatbuffers.Builder, driftCompData:boolean) {
  builder.addFieldInt8(11, +driftCompData, +false);
}
...
static createTrackerDataMask(builder:flatbuffers.Builder, info:boolean, status:boolean, rotation:boolean, position:boolean, rawAngularVelocity:boolean, rawAcceleration:boolean, temp:boolean, linearAcceleration:boolean, rotationReferenceAdjusted:boolean, rotationIdentityAdjusted:boolean, tps:boolean, driftCompData:boolean):flatbuffers.Offset {
  ...
  TrackerDataMask.addDriftCompData(builder, driftCompData);
...
unpackTo(_o: TrackerDataMaskT): void {
  ...
  _o.tps = this.tps();
  _o.driftCompData = this.driftCompData();
}
}
...
constructor(
  ...
  public driftCompData: boolean = false
){}
